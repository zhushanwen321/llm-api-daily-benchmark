...
class LLMEvalAdapter:
    ...
    # provider -> threading.Semaphore，用于 generate 并发控制
    _provider_sync_semaphores: dict[str, threading.Semaphore] = {}
    # provider -> AsyncConcurrencyLimiter，用于 agenerate 并发控制
    ...
    def _get_or_create_sync_semaphore(self, model: str) -> threading.Semaphore | None:
        """获取或创建 provider 级同步信号量，用于 generate。"""
    ...
    async def agenerate(
        ...
        - 使用 AsyncConcurrencyLimiter 替代 threading.Semaphore 控制并发
