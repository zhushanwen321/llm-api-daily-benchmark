...
class TestAnswerCorrectnessScorer:
    def test_exact_match(self):
        from benchmark.scorers.reasoning.answer_correctness import (
...
class TestReasoningCompletenessScorer:
    ...
    def test_get_metric_name(self):
        ...
        assert (
            ReasoningCompletenessScorer().get_metric_name() == "reasoning_completeness"
        )
...
class TestDifficultyAdaptationScorer:
    def test_empty_reasoning_gives_100(self):
        from benchmark.scorers.reasoning.difficulty_adaptation import (
            DifficultyAdaptationScorer,
        )
